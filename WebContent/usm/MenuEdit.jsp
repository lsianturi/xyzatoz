...
<!--
<div class="conTitle"><bean:message key="form.menuUserUpdate.title"></bean:message></div>
-->
...
<html:form action="/usm/MenuAction" onsubmit="return validateMenuForm(this);"> 
<html:hidden property="dispatch" value=""> </html:hidden>
	<table width="100%" border="0">
		<tbody>
			<tr>
				<td class="conLabel" width="180"><bean:message key="form.menuCode"/></td>
				<td class="conText" colspan="3"><html:text property='menuCode' maxlength="16" size="16" readonly="true" styleClass="frmReadOnly"/><font color="red">&nbsp;<html:errors property="menuCode" /></font></td>
			</tr>
			<tr>
