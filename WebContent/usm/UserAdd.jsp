	...
	<table width="100%" border="0">
		<tbody>
			<tr>
				...
				<td class="conText" colspan="3"><html:text property='roleCode' maxlength="16" size="16" /><font color="red">&nbsp;<html:errors property="roleCode" /></font></td>
			</tr>
			<tr>
				<td class="conLabel"><bean:message key="form.name"></bean:message></td>
				<td class="conText" colspan="3"><html:text property='description' maxlength="30" size="30" /><font color="red">&nbsp;<html:errors property="description" /></font></td>
			</tr>
		</tbody>
	</table>
	<table width="100%" border="0">
