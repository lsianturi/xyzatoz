...
<table width="100%">
	<tr>
		<td class="conTitle"><bean:message key="form.upload.title"></bean:message></td>
...
<html:form action="/upload.do" method="post" enctype="multipart/form-data" >	
	<html:hidden property="dispatch" value="upload"/>
	<table border="0">
		<tbody>
			<tr><td>&nbsp;</td>
			</tr>
			<tr>
				<td width="100" class="conLabel">Select Excel file: </td>
			...
			<tr>
				...
				<td><html:submit property="btnSubmit" styleClass="frmButton">
					<bean:message key="button.upload"></bean:message>
				</html:submit></td>
			</tr>
		</tbody>
	</table>
