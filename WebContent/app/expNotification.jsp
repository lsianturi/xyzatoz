...
<BODY>
	...
	<table width="100%">
		<tr>
			<td class="conTitle"><bean:message key="form.exp.notification.title"></bean:message></td>
		...
		<tr><td>&nbsp;</td></tr>
		<tr class="oddRow">
			<td class="conText">List of employee(s) with no finger print data and no leave request at the same date along with it's notification time.</td>
		</tr>
	</table>
	<!-- Help Page Finish -->
	...
	<c:if test="${DataList!=null}">
		<table width="100%" border="0" cellpadding="3" cellspacing="0"
			...
			<tr class="tblHeader">
				...
				<td><bean:message key="form.notif.first" /></td>
				<td><bean:message key="form.notif.second" /></td>
				<td><bean:message key="form.notif.third" /></td>
			...
			<c:forEach var="notif" items="${DataList.list}" varStatus="status">
				...
				<td class="celBorder"><c:out value="${notif.firstNotif}"/>&nbsp;</td>
				<td class="celBorder"><c:out value="${notif.secondNotif}"/>&nbsp;</td>
				<td class="celBorder"><c:out value="${notif.thirdNotif}"/>&nbsp;</td>
				<td class="celBorder" align="center">
						<a
							href="javascript:deduct('<c:out value="${notif.token}"/>')"><bean:message
								key="button.deduct"></bean:message></a>
				</td>
				</tr>
			</c:forEach>
		</table>
