...
<script type="text/javascript">
	...
	function add() {
		doGoToUrl('<c:url value="/updateActual.do?dispatch=add"/>');
	}
	function del(id) {
		doGoToUrl('<c:url value="/updateActual.do?dispatch=delete"/>'+'&id='+id);
	}
	...
	function excel() {
		doGoToUrl('<c:url value="/actual.do?dispatch=export2Excel" />');
	}
</script>
...
<table width="100%">
	<tr>
		<td class="conTitle"><bean:message key="form.actual.title"></bean:message></td>
...
<!-- Help Page Finish -->
<html:form action="/actual.do" method="post" >	
	...
	<c:if test="${DataList!=null}">
		<table width="100%" border="0" cellpadding="3" cellspacing="0" class="tblBorder">
			...
			<c:forEach var="actual" items="${DataList.list}" varStatus="status">
				<c:choose>
					...
					<td class="celBorder"><c:out value="${actual.company.name}"/>&nbsp;</td>
					<td class="celBorder"><c:out value="${actual.bookItem.book.name}"/>&nbsp;</td>
					<td class="celBorder"><c:out value="${actual.bookItem.name}"/>&nbsp;</td>
					<td class="celBorder"><c:out value="${actual.year}"/>&nbsp;</td>
					<td class="celBorder"><fmt:formatNumber type="number" maxFractionDigits="11" minFractionDigits="2" value="${actual.actual1}"/></td>
					<td class="celBorder"><fmt:formatNumber type="number" maxFractionDigits="11" minFractionDigits="2" value="${actual.actual2}"/></td>
					<td class="celBorder"><fmt:formatNumber type="number" maxFractionDigits="11" minFractionDigits="2" value="${actual.actual3}"/></td>
					<td class="celBorder"><fmt:formatNumber type="number" maxFractionDigits="11" minFractionDigits="2" value="${actual.actual4}"/></td>
					<td class="celBorder"><fmt:formatNumber type="number" maxFractionDigits="11" minFractionDigits="2" value="${actual.actual5}"/></td>
					<td class="celBorder"><fmt:formatNumber type="number" maxFractionDigits="11" minFractionDigits="2" value="${actual.actual6}"/></td>
					<td class="celBorder"><fmt:formatNumber type="number" maxFractionDigits="11" minFractionDigits="2" value="${actual.actual7}"/></td>
					<td class="celBorder"><fmt:formatNumber type="number" maxFractionDigits="11" minFractionDigits="2" value="${actual.actual8}"/></td>
					<td class="celBorder"><fmt:formatNumber type="number" maxFractionDigits="11" minFractionDigits="2" value="${actual.actual9}"/></td>
					<td class="celBorder"><fmt:formatNumber type="number" maxFractionDigits="11" minFractionDigits="2" value="${actual.actual10}"/></td>
					<td class="celBorder"><fmt:formatNumber type="number" maxFractionDigits="11" minFractionDigits="2" value="${actual.actual11}"/></td>
					<td class="celBorder"><fmt:formatNumber type="number" maxFractionDigits="11" minFractionDigits="2" value="${actual.actual12}"/></td>
				</tr>	
			</c:forEach>
		</table>
